...
;; FIXME: Package soap-client in GNU ELPA.
(when (featurep 'soap-client)
  (error (concat "Excorporate needs to be loaded before"
                 " anything else that requires soap-client")))
...
;; FIXME: Package soap-client in GNU ELPA then require it.
(provide 'soap-client)
