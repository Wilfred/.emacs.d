...
so I don't want them in the kill-ring.

I also prefer to delete the trailing newline rather than having to
press twice. Emacs provides the variable `kill-whole-line' and a
function `kill-whole-line' for this.
