...
elisp. It does not do this by default, to encourage developers to use
Cask instead (see https://github.com/flycheck/flycheck/pull/176). We
switch this behaviour back on.
