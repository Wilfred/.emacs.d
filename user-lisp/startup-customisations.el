...
(defvar wh/programming-quotes
  '("First, solve the problem. Then, write the code. -- John Johnson"
    ...
    "No one can become a [...] revolutionary by trying to imitate revolutionariness. You can only get there by pursuing the correct answer in all things, whether the correct answer is revolutionary or not. -- E Yudkowsky"))

(require 'random-utils)

;; populate the initial scratch buffer with a random quote.
(setq initial-scratch-message (random-choice wh/programming-quotes))
